...
#the function corr2d is used to calcalute 2d correlation
def corr2d(X, K):  #@save
...
# Construct a two-dimensional convolutional layer with 1 output channel and a kernel of shape (1, 2). For the sake of simplicity, we ignore the bias here
